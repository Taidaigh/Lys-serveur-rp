  ...
  SetTimeout(4000, function()
    ...
    if PlayersCrafting[source] == true then
      ...
      if FixToolQuantity <= 1 then
        TriggerClientEvent('esx:showNotification', source,'Vous n\'avez pas assez de défibrilateur')
      else
...
local function Craft2(source)
  ...
  SetTimeout(4000, function()
    ...
    if PlayersCrafting2[source] == true then
      ...
      if FixToolQuantity <= 1 then
        TriggerClientEvent('esx:showNotification', source,'Vous n\'avez pas assez de Dopamine')
      else
...
AddEventHandler('esx_ambulancejob:startCraft2', function()
  ...
  TriggerClientEvent('esx:showNotification', source,'Production de Seringue d\'adrénaline')
  Craft2(source)
end)
...
AddEventHandler('esx_ambulancejob:success', function()
  ...
  if societyAccount ~= nil then
    ...
    local playerMoney  = 400
    local societyMoney = 400
