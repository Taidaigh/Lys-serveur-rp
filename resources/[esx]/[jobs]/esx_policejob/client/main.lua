...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'sergeant_chef' then
    table.insert(elements, {label = _U('police_wear'), value = 'sergeant_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'inspec' then
    table.insert(elements, {label = _U('police_wear'), value = 'lieutenant_wear'})
  end

  if PlayerData.job.grade_name == 'capi' then
    table.insert(elements, {label = _U('police_wear'), value = 'lieutenant_wear'})
  end
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Déposer Argent sale', value = 'put_black_money'},
      {label = _U('remove_object'),  value = 'get_stock'},
      {label = _U('deposit_object'), value = 'put_stock'}
    }

    if PlayerData.job.grade_name == 'boss' then
      table.insert(elements, {label = 'Prendre Argent sale', value = 'get_black_money'})
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    table.insert(elements, { label = 'Vélo', value = 'fixter' })
	  table.insert(elements, { label = 'Cruiser', value = 'police2' })
	end
  ...
  if PlayerData.job.grade_name == 'sergeant' then
    table.insert(elements, { label = 'Moto', value = 'policeb'})
	  table.insert(elements, { label = 'Cruiser', value = 'police2' })
    table.insert(elements, { label = 'Cruiser v2', value = 'police3' })
	  table.insert(elements, { label = 'Volvo Banalisée', value = 'police4' })
    table.insert(elements, { label = 'Bus pénitentiaire', value = 'pbus'})
  ...
  if PlayerData.job.grade_name == 'sergeant_chef' then
    table.insert(elements, { label = 'Moto', value = 'policeb'})
    table.insert(elements, { label = 'Cruiser', value = 'police3' })
	  table.insert(elements, { label = 'Cruiser', value = 'police2' })
    table.insert(elements, { label = 'Cruiser v2', value = 'police3' })
	  table.insert(elements, { label = 'Volvo Banalisée', value = 'police4' })
    table.insert(elements, { label = 'Bus pénitentiaire', value = 'pbus'})
  ...
  if PlayerData.job.grade_name == 'lieutenant' then
    ...
    table.insert(elements, { label = 'Cruiser v2', value = 'police3' })
	  table.insert(elements, { label = 'Volvo Banalisée', value = 'police4' })
    table.insert(elements, { label = 'Ranger', value = 'sheriff2' })
    table.insert(elements, { label = 'Bus pénitentiaire', value = 'pbus'})
    table.insert(elements, { label = 'Antiémeute', value = 'riot'})
  end
  ...
  if PlayerData.job.grade_name == 'boss' then
    ...
    table.insert(elements, { label = 'Cruiser v2', value = 'police3' })
	  table.insert(elements, { label = 'Volvo Banalisée', value = 'police4' })
    table.insert(elements, { label = 'Shérif', value = 'sheriff' })
    table.insert(elements, { label = 'Ranger', value = 'sheriff2' })
    table.insert(elements, { label = 'Bus pénitentiaire', value = 'pbus'})
    table.insert(elements, { label = 'Antiémeute', value = 'riot'})
  end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'fine',
    {
      ...
      elements = {
        ...
        {label = 'Infraction Citoyens', value = 2},
...
--Amelioration vehicule Police Buffalos
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
	      local force = 65.0
