    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_realestateagentjob:annonce',result)
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'citizen_wear' then
        ...
        TriggerServerEvent("player:serviceOff", "realestateagent")
        ...
        while true do
            Citizen.Wait(1)
                ...
                if (affichenews == true) then
                    ...
                    DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~r~ IMMO DSD ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('esx_realestateagentjob:annonce')
AddEventHandler('esx_realestateagentjob:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_realestateagentjob:annoncestop')
AddEventHandler('esx_realestateagentjob:annoncestop', function()
    affichenews = false
