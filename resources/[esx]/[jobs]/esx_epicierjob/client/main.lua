...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'epicier' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function IsGradeStagiaire()
    if PlayerData ~= nil then
        local IsGradeStagiaire = false
        if PlayerData.job.grade_name == 'stagiaire' then
            IsGradeStagiaire = true
        end
        return IsGradeStagiaire
    end
end
...
function SetVehicleMaxMods(vehicle)
  ...
  local props = {
    ...
    modSuspension   = 0,
    modTurbo        = false,
	SetVehicleNumberPlateText(vehicle, "EPICIER")
  }
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'epicier', vehicleProps)
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
              ...
              TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1) -- teleport into vehicle
              SetVehicleColours(vehicle, 28, 0)
...
function OpenHarvestMenu()
	...
	if Config.EnablePlayerManagement and PlayerData.job.name == 'epicier' then
		local elements = {
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'epicier_harvest',
			{
				title    = _U('harvest'),
				elements = elements
			},
			function(data, menu)
				...
				if data.current.value == 'water' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startHarvest')
				end

				if data.current.value == 'bread' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startHarvest2')
				end

				if data.current.value == 'sucre' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startHarvest3')
				end
				
				if data.current.value == 'viande' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startHarvest4')
				end				

			end,
			function(data, menu)
				menu.close()
				CurrentAction     = 'epicier_harvest_menu'
...
function OpenCraftMenu()
	...
	if Config.EnablePlayerManagement and PlayerData.job.name == 'epicier' then
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'epicier_craft',
			{
				title    = _U('craft'),
				elements = elements
			},
			function(data, menu)
				if data.current.value == 'coca' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startCraft')
				end

				if data.current.value == 'hamburger' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startCraft2')
				end

			end,
			function(data, menu)
				menu.close()
				CurrentAction     = 'epicier_craft_menu'
...
function OpenResellMenu()
	...
	if Config.EnablePlayerManagement and PlayerData.job.name == 'epicier' then
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'epicier_resell',
			{
				title    = _U('resell'),
				elements = elements
			},
			function(data, menu)
				if data.current.value == 'hamburger' then
					menu.close()
					TriggerServerEvent('esx_epicierjob:startResell')
				end

			end,
			function(data, menu)
				menu.close()
				CurrentAction     = 'epicier_resell_menu'
...
function OpenSocietyActionsMenu()
  ...
  if (IsGradeStagiaire or IsGradeBoss()) then
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'epicier_actions',
    {
      title    = _U('epicier'),
      align    = 'top-left',
      elements = elements
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_epicier', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_epicierjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_epicierjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_epicierjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_epicierjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_epicierjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_epicierjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_epicierjob:putFridgeStockItems', itemName, count)
            end
...
AddEventHandler('esx_epicierjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_epicierjob:hasExitedMarker', function(zone)

  if zone == 'Craft' then
    TriggerServerEvent('esx_epicierjob:stopCraft')
    TriggerServerEvent('esx_epicierjob:stopCraft2')
    TriggerServerEvent('esx_epicierjob:stopCraft3')
    TriggerServerEvent('esx_epicierjob:stopCraft4')
  end

  if zone == 'Delivery' then
	TriggerServerEvent('esx_epicierjob:stopResell')
  end

  if zone == 'Harvest' then
    TriggerServerEvent('esx_epicierjob:stopHarvest')
    TriggerServerEvent('esx_epicierjob:stopHarvest2')
    TriggerServerEvent('esx_epicierjob:stopHarvest3')
    TriggerServerEvent('esx_epicierjob:stopHarvest4')
  end
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_epicierjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_epicierjob:hasExitedMarker', LastZone)
            end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
		...
		if CurrentAction == 'epicier_harvest_menu' then
            OpenHarvestMenu()
        end

		if CurrentAction == 'epicier_craft_menu' then
            OpenCraftMenu()
        end

		if CurrentAction == 'epicier_resell_menu' then
            OpenResellMenu()
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'epicier', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'epicier')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'epicier', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'epicier_actions') then
