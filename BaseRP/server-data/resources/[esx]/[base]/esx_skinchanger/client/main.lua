local Components = {
  ...
  {label = _U('watches_1'),             name = 'watches_1',     value = 0,  min = -1,  zoomOffset = 0.75,  camOffset = 0.15}, --
  {label = _U('watches_2'),             name = 'watches_2',     value = 0,  min = 0,  zoomOffset = 0.75,  camOffset = 0.15, textureof = 'watches_1'},
  {label = _U('bracelets_1'),           name = 'bracelets_1',   value = 0,  min = -1,  zoomOffset = 0.75,  camOffset = 0.15}, --
...
function GetMaxVals()
  ...
  local data = {
	...
	watches_1     = GetNumberOfPedPropDrawableVariations  (playerPed, 1) - 1,
    watches_2     = GetNumberOfPedPropTextureVariations   (playerPed, 1, Character['watches_1'] - 1),
    bracelets_1   = GetNumberOfPedPropDrawableVariations  (playerPed, 1) - 1,
    bracelets_2   = GetNumberOfPedPropTextureVariations   (playerPed, 1, Character['bracelets_1'] - 1)
  }
...
function ApplySkin(skin, clothes)
  ...
  if Character['watches_1'] == -1 then
    ...
    SetPedPropIndex(playerPed, 6, Character['watches_1'], Character['watches_2'], 6)  -- Ears Accessories
  end
  
  if Character['bracelets_1'] == -1 then
    ClearPedProp(playerPed, 7)
  else
    SetPedPropIndex(playerPed, 7, Character['bracelets_1'], Character['bracelets_2'], 7)  -- Ears Accessories
  end
