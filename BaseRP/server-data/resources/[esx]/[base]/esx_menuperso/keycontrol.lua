...
--------------------------------------------------------------------------------------------
-- Menu police -> esx_gouvjob
--------------------------------------------------------------------------------------------

		if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'gouv' and not ESX.UI.Menu.IsOpen('default', 'esx_gouvjob', 'gouv_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuGouv')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'gouv' and ESX.UI.Menu.IsOpen('default', 'esx_gouvjob', 'gouv_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.manettes then
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'gouv' and not ESX.UI.Menu.IsOpen('default', 'esx_gouvjob', 'gouv_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuGouv')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'gouv' and ESX.UI.Menu.IsOpen('default', 'esx_gouvjob', 'gouv_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
--------------------------------------- MANETTE
		...
		--------------------------------------------------------------------------------------------
-- Menu police -> esx_mafiajob
--------------------------------------------------------------------------------------------

		if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuMafia')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.manettes then
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuMafia')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
--------------------------------------------------------------------------------------------
-- Menu Disco -> esx_discojob
--------------------------------------------------------------------------------------------

		if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'disco' and not ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'DiscoActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuDisco')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'disco' and ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'DiscoActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.manettes then
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'disco' and not ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'DiscoActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuDisco')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'disco' and ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'DiscoActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
AddEventHandler('NB:closeAllSubMenu', function()
	...
	TriggerEvent('NB:closeMenuMafia')
	TriggerEvent('NB:closeMenuMecano')
	TriggerEvent('NB:closeMenuDisco')
...
-- Disco
RegisterNetEvent('NB:closeMenuDisco')
AddEventHandler('NB:closeMenuDisco', function()
	if ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'citizen_interaction') then
		ESX.UI.Menu.Close('default', 'esx_discojob', 'citizen_interaction')
	end
end)

-- Mafia
RegisterNetEvent('NB:closeMenuMafia')
AddEventHandler('NB:closeMenuMafia', function()
	if ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'citizen_interaction') then
		ESX.UI.Menu.Close('default', 'esx_mafiajob', 'citizen_interaction')
		
	elseif ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'vehicle_interaction') then
		ESX.UI.Menu.Close('default', 'esx_mafiajob', 'vehicle_interaction')
		
	elseif ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'object_spawner') then
		ESX.UI.Menu.Close('default', 'esx_mafiajob', 'object_spawner')
	end
end)
--------------------------------------------------------------------------------------------
...
Citizen.CreateThread(function()
	while true do
		...
		(ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'mafia_actions')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'citizen_interaction')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'vehicle_interaction')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_mafiajob', 'object_spawner')) or
		...
		(ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'DiscoActions')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_discojob', 'citizen_interaction')) or
