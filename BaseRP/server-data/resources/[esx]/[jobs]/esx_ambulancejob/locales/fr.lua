Locales['fr'] = {
  ...
  ['helico_spawn'] = 'Appuyez sur ~INPUT_CONTEXT~ pour sortir un hélicoptère',
  ['store_vehicle'] = 'Appuez sur ~INPUT_CONTEXT~ pour ranger le véhicule',
  ['ambulance'] = 'Ambulance',
  ['Suv'] = 'SUV',
  ['helicopter'] = 'hélicoptère',
  ...
  ['craft']      = 'Fabrication',
  ['craft_menu'] = 'appuyez sur E pour accéder au menu fabrication.',
  ...
  ['harvest']   = 'Fournisseur',
  ['harvest_menu'] = 'Appuyez sur E pour accéder au menu du fournisseur.',
