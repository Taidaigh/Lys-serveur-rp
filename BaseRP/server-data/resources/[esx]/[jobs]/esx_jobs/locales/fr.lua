Locales['fr'] = {
	...
	--Lumber Jack job
		['lj_locker_room'] 						= "Bucheron Vestiaire",
	...
	--fuel
		['f_oil_refiner'] 						= "Raffineur Vestiaire",
		['f_drill_oil'] 							= "Extraction Pétrole",
		['f_fuel'] 										= 'Pétrol',
		['f_drillbutton'] 						= 'appuyez sur ~INPUT_PICKUP~ pour Forer.',
		['f_fuel_refine'] 						= 'Pétrol raffiné',
		['f_refine_fuel_button'] 			= 'press ~ INPUT_PICKUP ~ to rafiner.',
		...
		['delivery'] 									= 'livraison essence',
		['offshore_prod'] 									= 'Vers Offshore Oil',

	--miner
		['m_miner_locker'] 						= "Mineur Vestiaire",
		['m_rock'] 										= 'rocher',
	...
	--slaughterer
		['s_slaughter_locker'] 				= "Abbateur Vestiaire",
		['s_hen'] 										= 'poulailler',
