...
-- 		       TriggerServerEvent('esx_unicornjob:annonce',result)
--
-- 		    end
--
--
...
RegisterNetEvent('esx_unicornjob:annonce')
AddEventHandler('esx_unicornjob:annonce', function(text)
 		texteafiche = text
 		affichenews = true
...
RegisterNetEvent('esx_unicornjob:annoncestop')
AddEventHandler('esx_unicornjob:annoncestop', function()
 		affichenews = false
