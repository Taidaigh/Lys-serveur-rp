...
Config.NPCJobEarnings         = {min = 84, max = 85}

Config.Zones = {

	--CarPound = {
	--	Pos   = {x = 409.14, y = -1622.52, z = 28.30},
	...
	--CarPoundSpawnPoint = {
	--	Pos   = {x = 405.35, y = -1634.74, z = 28.30},
	--	Size  = {x = 1.5, y = 1.5, z = 1.0},
	--	Type  = -1
	--},

	MecanoActions = {
		Pos   = {x = -1148.520, y = -1713.459, z = 8.449},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	BossActions = {
		Pos   = {x = -1149.895, y = -1710.504, z = 8.485},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	Garage = {
		Pos   = {x = 548.65301513672, y = -189.45672607422, z = 53.451334686279},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	Craft = {
		Pos   = {x = -1188.263, y = -1712.768, z = 3.449},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = {x = -1197.902, y = -1756.384, z = 3.700},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -1197.438, y = -1747.238, z = 2.754},
	...
	VehicleDelivery = {
		Pos   = {x = -1205.935, y = -1746.651, z = 3.192},
