...
Citizen.CreateThread(function()
		...
		AddTextComponentString('Serrurier Voiture')
		EndTextCommandSetBlipName(blip)
end)

-- Create Blips
-- Citizen.CreateThread(function()
		-- local blip = AddBlipForCoord(Config.Zones.place2.Pos.x, Config.Zones.place2.Pos.y, Config.Zones.place2.Pos.z)
		-- SetBlipSprite (blip, 134)
		-- SetBlipDisplay(blip, 4)
		-- SetBlipScale  (blip, 0.7)
		-- SetBlipColour (blip, 3)
		-- SetBlipAsShortRange(blip, true)
		-- BeginTextCommandSetBlipName("STRING")
		-- AddTextComponentString('Serrurier Moto')
		-- EndTextCommandSetBlipName(blip)
-- end)

-- Create Blips
-- Citizen.CreateThread(function()
		-- local blip = AddBlipForCoord(Config.Zones.place3.Pos.x, Config.Zones.place3.Pos.y, Config.Zones.place3.Pos.z)
		-- SetBlipSprite (blip, 134)
		-- SetBlipDisplay(blip, 4)
		-- SetBlipScale  (blip, 0.7)
		-- SetBlipColour (blip, 3)
		-- SetBlipAsShortRange(blip, true)
		-- BeginTextCommandSetBlipName("STRING")
		-- AddTextComponentString('Serrurier Publique')
		-- EndTextCommandSetBlipName(blip)
-- end)
